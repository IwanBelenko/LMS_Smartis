    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("source", models.CharField(choices=[("manual", "Ручной импорт"), ("one_c", "Выгрузка 1С")], default="manual", max_length=20, verbose_name="Источник")),
                ...
                ("effective_date", models.DateField(blank=True, null=True, verbose_name="Дата среза")),
                ...
                ("imported_by", models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="hr_import_batches", to=settings.AUTH_USER_MODEL)),
            ],
            options={
