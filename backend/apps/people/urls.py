...
from .views import (
    ...
    CandidateDetailView,
    CandidateAssignmentOptionsView,
    CandidateAssignmentView,
    CandidateCommentListCreateView,
    CandidateExperienceDetailView,
    CandidateExperienceListCreateView,
    CandidateListCreateView,
    CandidateHireView,
    CandidateOfferApproveView,
    CandidateOfferDetailView,
    CandidateOfferDownloadView,
    ...
    CandidateStageDetailView,
    CandidateStageEventListView,
    EmployeeDetailView,
    EmployeeExportView,
    EmployeeImportView,
    LearningImportView,
    ...
    OrganizationManagerOptionsView,
...
urlpatterns = [
    ...
    path("org/manager-options/", OrganizationManagerOptionsView.as_view(), name="organization-manager-options"),
    ...
    path("candidates/<int:pk>/assignment/", CandidateAssignmentView.as_view(), name="candidate-assignment"),
    path("candidates/<int:candidate_id>/comments/", CandidateCommentListCreateView.as_view(), name="candidate-comments"),
    path("candidates/<int:candidate_id>/experiences/", CandidateExperienceListCreateView.as_view(), name="candidate-experiences"),
    path("candidates/<int:candidate_id>/stage-events/", CandidateStageEventListView.as_view(), name="candidate-stage-events"),
    path("candidates/<int:candidate_id>/resumes/", CandidateResumeListCreateView.as_view(), name="candidate-resumes"),
    path("candidates/<int:pk>/hire/", CandidateHireView.as_view(), name="candidate-hire"),
    path("candidate-resumes/<int:pk>/", CandidateResumeDetailView.as_view(), name="candidate-resume-detail"),
    path("candidate-resumes/<int:pk>/download/", CandidateResumeDownloadView.as_view(), name="candidate-resume-download"),
    path("candidate-experiences/<int:pk>/", CandidateExperienceDetailView.as_view(), name="candidate-experience-detail"),
    path("candidate-assignment-options/", CandidateAssignmentOptionsView.as_view(), name="candidate-assignment-options"),
    ...
    path("offers/<int:pk>/download/", CandidateOfferDownloadView.as_view(), name="candidate-offer-download"),
    ...
    path("candidate-stages/<int:pk>/", CandidateStageDetailView.as_view(), name="candidate-stage-detail"),
